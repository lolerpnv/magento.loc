...
class Toni_MaxOrderAmount_Helper_Data extends Mage_Core_Helper_Data
{

    const XML_PATH_ACTIVE =

        'sales/toni_maxorderamount/active';

    const XML_PATH_SINGLE_ORDER_TOP_AMOUNT =

        'sales/toni_maxorderamount/single_order_top_amount';

    const XML_PATH_SINGLE_ORDER_TOP_AMOUNT_MSG =

        'sales/toni_maxorderamount/single_order_top_amount_msg';
